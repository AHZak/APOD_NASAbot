...
### BOT
MSG = {
    "START"     : "Welcome to <b>APOD</b> bot!\nIt gives you access to NASA's Astronomy Picture of the Day archive in your comfort on Telegram.\n\nYou can:\n<b>• pass a date (like 2020-2-22)</b>\n<b>• use /today for the most recent picture</b>\n<b>• or let the bot surprise you by /random !</b>\n\nThis is an <b>open-source</b> project.\nSee About for more information.\n\nWith 💛 by <strong>Amir</strong>",
